...
\NormalTok{m.vec.int[}\DecValTok{1}\OperatorTok{:}\NormalTok{id.comb] <-}\StringTok{ }\DecValTok{1}  \CommentTok{# position 1 to 13 should be assigned 1}
\CommentTok{# re-optimize B for fixed m.vec}
\NormalTok{B.int <-}\StringTok{ }\KeywordTok{sqrt}\NormalTok{(}\KeywordTok{sum}\NormalTok{(c.or}\OperatorTok{/}\NormalTok{m.vec.int)}\OperatorTok{/}\KeywordTok{sum}\NormalTok{(m.vec.int}\OperatorTok{*}\NormalTok{H.vec))}\CommentTok{#0.2431548}
\CommentTok{# total cost }
\NormalTok{c.cost.int <-}\StringTok{ }\KeywordTok{jrp.obj.fun}\NormalTok{( }\DataTypeTok{m =}\NormalTok{ m.vec.int, }\DataTypeTok{B=}\NormalTok{B.int, }\DataTypeTok{cor =}\NormalTok{ c.or,}\DataTypeTok{Hvec=}\NormalTok{H.vec, }\DataTypeTok{cor0 =}\NormalTok{ c.or0)}\CommentTok{#18646.93}
...
\KeywordTok{jrp.obj.fun2}\NormalTok{(m.vec.int}\OperatorTok{*}\NormalTok{B)}\CommentTok{#190854.8}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{jrp.obj.fun2}\NormalTok{(}\KeywordTok{rep}\NormalTok{(.}\DecValTok{00001}\NormalTok{,}\DecValTok{62}\NormalTok{))}\CommentTok{#9724500000}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{jrp.obj.fun2}\NormalTok{(}\KeywordTok{rep}\NormalTok{(}\DecValTok{15}\NormalTok{,}\DecValTok{62}\NormalTok{))}\CommentTok{#173920.9}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{copt_sol2 }\CommentTok{#5.671162e+04}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{copt_sol3 }\CommentTok{#2.995570e+05}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{jrp.obj.fun}\NormalTok{(}\DataTypeTok{m=}\NormalTok{ copt_sol3}\OperatorTok{$}\NormalTok{solution) }\CommentTok{#299557}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{df <-}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}
  \DataTypeTok{Box_sorting =} \KeywordTok{t}\NormalTok{(product_data}\OperatorTok{$}\NormalTok{b_sorting))}
\NormalTok{df}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{sum}\NormalTok{(product_data}\OperatorTok{$}\NormalTok{b_sorting)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{sum}\NormalTok{(product_data}\OperatorTok{$}\NormalTok{b_sorting) }\OperatorTok{>}\StringTok{ }\NormalTok{rack_width }\CommentTok{#true}
\end{Highlighting}
\end{Shaded}
