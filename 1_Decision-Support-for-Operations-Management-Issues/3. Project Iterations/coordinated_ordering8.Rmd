...
$\tilde v_i= cum.ord.share$
```{r}
cum.ord.share <-cumsum(as.vector(ord.share))
cum.ord.share
```
...
#Initial Stock level
stock.level <- (l.start2*rack_length)/product_data$b_not_sorting
stock.level[item]
